...
public class TestB1BasicActivityKT041 extends ViewTest {
   ...
   public void check_01_Fields_Availability() { //Check Layout Specification
       testField(layout,"dist", 18, Distance.class,false);
       testField(layout,"weight", 18, Weight.class, false);
       testField(layout,"temp", 18, Temperature.class, false);
    ...
    public void check_02_Methods_Availability() {
        ...
        testMethod(layout,"convertUnit",20,params,double.class);

        params = new Class[2];
        params[0] = double.class;
        params[1] = boolean.class;
        testMethod(layout,"strResult",17,params,String.class);
    }
